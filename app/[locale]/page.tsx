      ...
      {propertiesWithMedia.length > 0 && (
        ...
        >
          ...
          <div className="fp-header flex flex-col gap-4 md:flex-row md:justify-between md:items-end mb-10 md:mb-12">
            <div>
              <p className="text-[10px] tracking-[5px] text-gold uppercase mb-1">
                {th('sectionEyebrow')}
              </p>
            ...
            <Link
              href={`/${locale}/biens`}
              className="text-[11px] tracking-[3px] uppercase text-white border-b-2 border-gold pb-1 hover:text-gold transition-colors self-start md:self-auto"
            >
              {th('seeAll')}
            </Link>
          </div>
