...
export default function BiensPage() {
  ...
  const pillClass = (active: boolean) =>
    `text-xs tracking-ui uppercase px-4 py-1.5 rounded-full border transition-all duration-200 cursor-pointer whitespace-nowrap ${
      active
  ...
  const inputClass =
    'border border-white/20 rounded-lg px-3 py-2 text-white text-xs placeholder:text-white/35 focus:outline-none focus:border-gold/70 transition-colors bg-white/8';
  ...
  return (
    <main className="min-h-screen bg-[#0a0f1a]">
      ...
      <div className="pt-32 md:pt-40 pb-10 px-6 md:px-16">
        ...
        <h1 className="font-serif text-4xl md:text-5xl font-light tracking-title text-white mb-10">
          {t('title')}
        </h1>
        ...
        <button
          ...
          className="md:hidden flex items-center gap-2 text-xs tracking-ui uppercase text-white/50 hover:text-gold transition-colors mb-4 cursor-pointer"
        >
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-4 items-end">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs tracking-label uppercase text-white/60">{t('filters.city')}</label>
                <select
                  value={filters.city}
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs tracking-label uppercase text-white/60">{t('filters.status')}</label>
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs tracking-label uppercase text-white/60">{t('filters.rooms')}</label>
                <div className="flex gap-2">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs tracking-label uppercase text-white/60">{t('filters.type')}</label>
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-4 items-end">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs tracking-label uppercase text-white/60">{t('filters.priceRange')}</label>
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs tracking-label uppercase text-white/60">{t('filters.surfaceRange')} (m²)</label>
                <div className="flex items-center gap-2">
                  <input
                    type="number" min={0}
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs tracking-label uppercase text-white/60">{t('filters.sort')}</label>
                <select
                  value={filters.sort}
              ...
              {hasActiveFilters && (
                <button
                  ...
                  className="text-xs tracking-ui uppercase text-gold hover:text-white border border-gold/40 hover:border-white/40 px-4 py-2 rounded-lg transition-all duration-200 cursor-pointer self-end"
                >
                  {t('filters.reset')}
                </button>
              )}
        ...
        {!mapOpen ? (
          ...
          >
            ...
            <div className="relative flex flex-col items-center justify-center gap-2 h-full">
              ...
              <span className="text-xs tracking-ui uppercase text-white/80 group-hover:text-gold transition-colors">
                {t('filters.exploreMap')}
              </span>
              <span className="text-xs tracking-label uppercase text-white/35">
          ...
          >
            ...
            <button
              ...
              className="absolute top-4 right-4 z-1001 flex items-center gap-2 px-4 py-2 rounded-full text-xs tracking-ui uppercase text-white/80 hover:text-white cursor-pointer transition-colors"
              style={{
        ...
        {error && (
          <div className="flex flex-col items-center gap-4 py-32 text-center">
            ...
            <button
              ...
              className="mt-4 text-xs tracking-ui uppercase text-gold border border-gold/40 px-6 py-2 rounded-lg hover:bg-gold/10 transition-colors cursor-pointer"
            >
              {t('retry')}
            </button>
          </div>
